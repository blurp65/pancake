...
sudo apt install -y gnupg flex bison lsb-release build-essential zip curl zlib1g-dev libc6-dev-i386 libncurses5 \
...
libvirt-daemon-system libvirt-clients bridge-utils virtinst virt-manager uuid*
