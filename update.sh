...
libvirt-daemon-system libvirt-clients bridge-utils virtinst virt-manager uuid* git-core gitk git-gui curl lvm2 thin-provisioning-tools python3-pkg-resources python3-virtualenv python3-oauth2client xz-utils python3.6 nano screen
